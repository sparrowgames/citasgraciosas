...
//				print('<a href="votos.php?ide='.$linea[0].'&cat=indice&tp=2" target="_blank">');
				print("<font color='#000000' size='2'><strong>".$linea[2]."</strong></font>");//</a>
				print('<br><input type="image" src="images/votar.gif" onClick="');
						  print("javascript:window.open('Gvotos.php?ide=".$linea[0]."&cat=indice&tp=2', 'noimporta', 'width=550, height=300, scrollbars=NO')");
print('"><br><br><br>'); 
			}else{
