...
<table class="maintable" cellspacing="0" cellpadding="0" >
      ...
      <div align="center" class="Estilo3">
        <p class="Estilo4 Estilo9 Estilo10">&nbsp;</p>
        <span class="Estilo11" style="font-weight: bold; font-size: 14px">&iexcl;Tu mensaje ha sido enviado! </span>
        <p class="Estilo7"><img src="images/imgmail.gif" alt="mail" width="96" height="91" longdesc="mail" /></p>
        <p>&nbsp;</p>
        <table width="90%" border="0">
          ...
          <tr>
            <td><div align="center"><span class="Estilo7 Estilo9">&iexcl;Gracias por participar! </span></div></td>
          </tr>
          <tr>
            <td><hr /></td>
          </tr>
