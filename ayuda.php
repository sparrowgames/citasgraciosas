...
<table class="maintable" cellspacing="0" cellpadding="0" >
				...
				<tr>
				  ...
				  <td class="td2_2_main"><!-- InstanceBeginEditable name="ventana" -->
					  <p>&nbsp;</p>
					  <p align="center" style="font-size: 18px; font-weight: bold; color: #000000">&iexcl;&iexcl;Bienvenido	a	la	pagina	de ayuda!!</p>
					  <blockquote>
					    <p>Puedes ver el tutorial en Flash conducido por  nuestra mascota Edi para aprender las funciones basicas de la web. Tambien puedes entrar en el foro para preguntas mas especificas.</p>
					    <p>&nbsp; </p>
				    </blockquote>
					  <p>
					    <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="400" height="300">
					      <param name="movie" value="http://perso.wanadoo.es/juanuxx/edi.swf" />
					      <param name="quality" value="high" />
					      <embed src="http://perso.wanadoo.es/juanuxx/edi.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="400" height="300"></embed>
				          </object>
				          </p>
