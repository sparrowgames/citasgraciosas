...
<table class="maintable" cellspacing="0" cellpadding="0" >
      ...
      <div align="center"><form action="/cgi-bin/mailto/frases@champinet.com" method="post" name="form2" id="form2">
        <input type="hidden" name="Acknowledge" value="http://www.citasgraciosas.com/agradecimientosMAIL.php" />
		<input type="hidden" name="Subject" value="Frases Graciosas" />
		
         <div align="center"> 
          <table width="97%" border="0">
            <tr>
              <td><div align="center"><strong>Escribe aqu&iacute; la frase que deseas enviarnos  
                y pulsa el bot&oacute;n.</strong></div></td>
            </tr>
          </table>
          <p>
          ...
          <table border="0" align="center">
            <tr>
              <td><img src="images/atencion.jpg" width="44" height="68" /></td>
              <td><span style="font-size: 9px"><font color="#FF0000">Recibiremos  tu frase en un mail</font><br />
                <br />
              </span><span class="Estilo3" style="font-weight: bold">&iexcl;NO SE INTRODUCIR&Aacute; EN LA BASE DE DATOS!</span></td>
            </tr>
          </table>
          <p align="center">              <br />
          </p>
