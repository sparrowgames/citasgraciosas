...
<?php
print('<label>
<div align="center"><img src="images/titulomovil.png"/></div>
</label>');
/*<script> 
function cambiar(){ 
document.frm.submit(); 
...
<form name="frm" method="post" action="formulario.php" onchange="cambiar()"> 
<select name="cambiar"> 
...
print('<table width="100%" border="0" align="center">
  <tr>
    ...
    <td width="25%"><div align="center">');
		...
		print('<a href="movil.php?ide='.$numero.'"><img src="'.$imagen.'" /></a> <span class="Estilo2">Aleatoria. </span>');
...
<div align="center"><strong><span class="Estilo4">citasgraciosas.com 2005-<?php echo date('Y') ?> <br />Juanuxx y Alex. <br />
		          ...
		          <br />
  <a href="http://webdesing.champinet.com/cgi-bin/awstats.pl?config=citasgraciosas" target="_blank"><img src="images/stat.gif" width="20" height="20" border="0" /></a><span class="Estilo3">-</span></span></span><a href="/index.php"><img src="images/pc.png" width="20" height="20" border="0" /></a></strong></div>
</span>
</body>
</html>
